...
{
	private SharedPreferences scoreStore;
	...
	public SpaceGame(Context context){
		this.scoreStore = context.getSharedPreferences("SpaceGameStore", Context.MODE_PRIVATE);
	}
	...
	public void render(){
		...
		if(!isRunning){
			...
			int bestScore = scoreStore.getInt("bestScore", 0);
